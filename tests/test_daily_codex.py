...
class DailyModelApiTests(unittest.TestCase):
    def test_main_uses_model_api_content_and_image_when_not_dry_run(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.dict("os.environ", {"NIGHT_CURATOR_HOME": str(state), "NIGHT_CURATOR_FORCE_FALLBACK": "0"}, clear=False), \
                 ...
                 mock.patch.object(daily, "generate_content", fake_content), \
                 mock.patch.object(daily, "generate_image", fake_image):
